...
<br/><br/><br/>
<!-----------------------------------navbar ends here------------------------------------------>
<!-----------------------------customer_payment_cancel code starts here------------------------------------------>
<div class="container">
  <div class="row">
    <div class="col">
      <div class="card">
        <div class="card-header bg-primary text-white"><h5>Payment Cancel</h5></div>
         <div class="card-body">
               
                 <p class="card-text">Hello, <?php echo $_SESSION['name']; ?> Your Payment Process is canceled.
                  You can continue your shopping.</p><br/>
...
<!-----------------------------customer_payment_cancel code ends here------------------------------------------>
